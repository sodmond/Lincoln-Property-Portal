    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('/home') }}">
                <div class="sidebar-brand-icon" style="background-color:;">
                    <img src="{{ asset('/img/logo.png') }}" alt="Lincoln City Property" width="60">
                </div>
            ...
            <!-- Nav Item - Referral List -->
            <li class="nav-item">
                <a class="nav-link" href="{{ url('/referral_list') }}">
                    <i class="fas fa-fw fa-users"></i>
                    <span>Referral List</span></a>
            </li>

            <!-- Nav Item - Search Result -->
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ url('/registered_admin') }}">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Lincoln City Property {{date('Y')}}</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
